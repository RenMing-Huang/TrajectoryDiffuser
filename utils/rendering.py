...
class MuJoCoRenderer:
    ...
    def render(self, observation, dim=256, partial=True, qvel=True, render_kwargs=None, conditions=None):
    ...
    def composite(self, savepath, paths, dim=(1024, 256), render_kwargs=None, **kwargs):
        if render_kwargs is None:
            render_kwargs = {
                'trackbodyid': 2,
                'distance': 10,
